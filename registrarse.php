                                        ...
                                        <div class="card-body d-flex flex-column align-items-center">
                                            ...
                                            <form class="text-center" action="registrar-usuario.php" method="post">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control item" type="text" name="nombre"
                                                        id="nombre" placeholder="Nombre" required minlength="2">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="apellido" class="form-label" style="font-size: 20px;">Ingresa tu apellido/s</label>
                                                    <input class="form-control item" type="text" name="apellido"
                                                        placeholder="Apellido/s" id="apellido" required minlength="2">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="correo" class="form-label" style="font-size: 20px;">Ingresa tu correo electrónico</label>
                                                    <input class="form-control item" type="email" name="correo"
                                                        inputmode="email" id="correo" placeholder="ejemplo@gmail.com"
                                                        required minlength="4">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="clave" class="form-label" style="font-size: 20px;">Crea una contraseña</label>
                                                    <input class="form-control item" type="password" name="clave"
                                                        id="clave" placeholder="*********" required minlength="8">
                                                    <small class="form-text text-muted" style="font-size: 15px;">La contraseña debe tener al menos 8 caracteres.</small>
                                                </div>
                                                <div class="mb-3">
                                                    <button class="btn btn-primary d-block w-100" type="submit" name="registrar_usuario">Registrarse
                                                    </button>
